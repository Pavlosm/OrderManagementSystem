...
public class OrderServiceTests
{
    ...
    private readonly Mock<IOrderPublisherService> _orderPublisherServiceMock = new (MockBehavior.Strict);
    ...
    private OrderService CreateSut() => new (
        ...
        _orderPublisherServiceMock.Object);
    ...
    public async Task PlaceOrderAsync_Pickup_ShouldReturnOrder_WhenValidRequest()
    {
        ...
        _orderPublisherServiceMock
            .Setup(proxy => proxy.PublishOrderAsync(It.Is<OrderDomainEventOutbox>(e => e.Type == MessageType.Created)))
    ...
    public async Task UpdateStatusAsync_ShouldReturnSuccess_WhenValidTransition()
    {
        ...
        _orderPublisherServiceMock
            .Setup(proxy => proxy.PublishOrderAsync(It.Is<OrderDomainEventOutbox>(e => e.OrderId == order.Id)))
            .Returns(Task.CompletedTask);

        _orderRepositoryMock
            .Setup(repo => repo.UpdateStatusAsync(1, stateMock.Object, "user1", It.IsAny<byte[]>(), It.IsAny<OrderDomainEventOutbox>()))
            .ReturnsAsync(1);
    ...
    public async Task SetDeliveryStatus_ShouldReturnSuccess_WhenValidDeliveryStaffId()
    {
        ...
        _orderRepositoryMock
            .Setup(repo => repo.SetDeliveryStaffAsync(1, stateMock.Object, "user1", It.IsAny<byte[]>(), It.IsAny<OrderDomainEventOutbox>()))
            .ReturnsAsync(1);
    ...
    {
        _menuItemServiceMock.VerifyAll();
        _menuItemServiceMock.VerifyNoOtherCalls();
        _orderPublisherServiceMock.VerifyAll();
        _orderPublisherServiceMock.VerifyNoOtherCalls();
